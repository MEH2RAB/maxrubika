...
class ClearBlackList:
    async def clear_black_list(
        self: "maxrubika.Client",
        chat: str,
        exclude: Optional[Union[str, List[str]]] = None
    ):
        """
        Clear black list with unban all banned members in a group or channel.
        ...
        if not final_guids:
            return ({"status": "OK", "message": "All banned members are in exceptions list. No one to unban."})
