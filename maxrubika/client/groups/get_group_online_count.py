...
class GetGroupOnlineCount:
    async def get_group_online_count(self: "maxrubika.Client", group: str):
        """
        Retrieves the number of online members in a specified group.
        ...
        return await self.request(method = 'getGroupOnlineCount', input = {'group_guid': group_guid})