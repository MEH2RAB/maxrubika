...
<a href="../bot-guide/" class="md-button" style="background: #ffffff; border: 1px solid #ddd; border-radius: 8px; padding: 10px 20px; font-weight: bold; color: #333; text-decoration: none;">← بازگشت به مستندات ربات</a>

<a href="../bot-decorators/" class="md-button md-button--primary" style="background: linear-gradient(135deg, #4CAF50, #388E3C); border: none; border-radius: 8px; padding: 10px 20px; font-weight: bold; color: white; text-decoration: none;">صفحه بعد →</a>
